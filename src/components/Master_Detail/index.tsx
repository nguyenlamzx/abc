...
interface IMasterDetailStates {
  currentDisplayTabIndex?: number,
  masterDetailText?: Array<any>,
  WarningMessageOpen?: boolean,
  WarningMessageText?: string,
}

export default class MasterDetail extends Component<IMasterDetailProps, IMasterDetailStates> {
  constructor(props:IMasterDetailProps) {
    super(props);
